...
data_dir = r'C:\Users\Asus\Downloads\MOT\src\ByteTrack\YOLOX_outputs\best_30'
saved_dir = r'C:\Users\Asus\Downloads\MOT\src\ByteTrack\YOLOX_outputs\best_30_gsi'

for txt_file in os.listdir(data_dir):
    print(txt_file)
    data_path = os.path.join(data_dir, txt_file)
    saved_data_path = os.path.join(saved_dir, txt_file)
    GSInterpolation(data_path, saved_data_path, interval=20 ,tau = 10)