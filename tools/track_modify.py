...
def main(exp, args, num_gpu):
    ...
    *_, summary = evaluator.evaluate(
    ...
    if args.mot20:
        gtfiles = glob.glob(os.path.join(r'datasets\MOT20\train', r'*\gt\gt{}.txt'.format(gt_type)))
    else:
        # print(os.path.join('datasets/MOT20/train', '*/gt/gt{}.txt'.format(gt_type)))
        gtfiles = glob.glob(os.path.join(r'datasets\mot\train', r'*/gt/gt{}.txt'.format(gt_type)))
